            ...
            <div className="space-y-8 text-white text-lg leading-relaxed font-light">
              ...
              <div className="border-l-[1px] border-electric pl-6 py-2 my-6">
                <p className="text-xl md:text-2xl text-white font-light leading-tight">
                  "Amadores caçam 'produtos vencedores'. A Elite constrói <span className="serif-italic">ecossistemas</span> de marca DTC que tornam a venda <span className="serif-italic">inevitável.</span>"
                </p>
              </div>
